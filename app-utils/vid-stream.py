...
def main():
    ...
    parser.add_argument("-d", "--delay", type=int, default=30,
                        help=" Time delay")
    parser.add_argument(
        "-v", "--psnrtriggervalue", type=int, default=30,
        help="PSNR Trigger Value"
    )
    parser.add_argument(
        "-r", "--ref", type=str, default="../asset/Megamind.avi",
    ...
    parser.add_argument(
        ...
        "--undertest",
        type=str,
        default="../asset/Megamind_bugy.avi",
    ...
    uTSi = (
        int(captUndTst.get(cv.CAP_PROP_FRAME_WIDTH)),
    ...
    print(
        "Reference frame resolution: Width={} Height={} of nr#: {}".format(
            refS[0], refS[1], captRefrnc.get(cv.CAP_PROP_FRAME_COUNT)
        )
    )
